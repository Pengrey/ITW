define(['durandal/app'], function (app) {
    var vm = function () {
        ...
        //---Variáveis locais
        var self = this;
        var baseUri = 'http://ieeta-cloudpt.web.ua.pt/pokemons/api/Pokemons/GetAlpabeticalPage';
        self.displayName = 'Pokemóns List';
        ...
        self.activate = function (id) {
            ...
            var composedUri = baseUri + "?page=" + self.currentPage() + "&pageSize=" + 963;
